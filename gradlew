...
# This is reliable if $PWD and realpath agree.
    ...
    for arg do
        if
            case $arg in                                #(
              ...
              /?*)  t=${arg#/} t=/${t%%/*}              # look for Windows path prefix #(
                    [ -e "$t" ] ;;                      #(
              *)    false ;;
            esac
        then
        ...
        # temporary variables.  (e.g. three times for the variables
        # temporary1, temporary2 and temporary3)
